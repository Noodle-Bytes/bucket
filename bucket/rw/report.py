...
class ReportWriter(Writer):
    ...
    def __init__(
        ...
        *,
        ...
        self.report_args: list[str] = []
        for enabled, flag in [
            (description, "--no-description"),
            (motivation, "--no-motivation"),
            (tier_tags, "--no-tier-tags"),
            (axes, "--no-axes"),
            (axis_values, "--no-axis-values"),
            (goals, "--no-goals"),
            (bucket_counts, "--no-bucket-counts"),
            (summary, "--no-summary"),
        ]:
            if not enabled:
                self.report_args.append(flag)
        if results:
            self.report_args.append("--results")
        self.report_args += ["--max-axis-values", str(max_axis_values)]
