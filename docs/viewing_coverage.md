...
There are three ways to view the collected coverage.

1) Terminal
2) Browser (generated HTML)
...
To run a launch smoke test (CI-style startup check):
...
Cross-platform CI builds run in `.github/workflows/electron-builds.yml` and publish artifacts for:
